...
public class PayingPage extends BasePage {
    ...
    @Step("Вводим номер телефона '375297777777'")
    ...
    @Step("Получаем стоимость на кнопке")
    ...
    @Step("Получение плейсхолдера 'Номер карты'")
    ...
    @Step("Получение плейсхолдера 'Срок действия'")
    ...
    @Step("Получение плейсхолдера 'CVC'")
    ...
    @Step("Получение плейсхолдера 'Имя держателя (как на карте)'")
    ...
    @Step("Проверяем, что логотипы платежных систем отображаются")
